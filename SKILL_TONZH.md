...
| 违禁词 | 处理方式 |
|--------|----------|
| 第一、第一名、第一家 | 删除或替换为"较早" |
| 首个、首次、首位 | 删除"首"字或替换为"较早" |
| 第一位、第一大、第一品牌 | 删除"第一" |
| 行业第一、全国第一、国内第一、全球第一 | 删除"第一" |

#### 二、"最"系列（严禁使用）
| 违禁词 | 替换为 |
|--------|--------|
| 最、最好、最佳、最新、最大 | 优秀/优良/当前/大/较大 |
| 最小、最高、最低、最快、最强 | 小/较高/较低/快/较强 |
| 最先进、最可靠、最受欢迎 | 先进/可靠/广受好评 |
| 最受人尊敬 | 值得信赖 |
...
| 国家级、国际级 | 省/市级或直接删除 |
| 国家级专精特新 | 专精特新 |
| 全球领先、行业领先、国内领先 | 先进/前列 |
| 国际领先、领先水平、领先地位 | 先进/先进水平 |
